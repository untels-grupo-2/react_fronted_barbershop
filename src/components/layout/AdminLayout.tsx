...
import { Assessment, CalendarMonth, ContentCut, Dashboard, EventNote, Logout, Menu, Reviews, RoomService } from '@mui/icons-material';
...
const AdminLayout = () => {
  ...
  const navItems = useMemo(
    () => [
      ...
      { label: 'Reservas', path: '/reservas', icon: <EventNote /> },
